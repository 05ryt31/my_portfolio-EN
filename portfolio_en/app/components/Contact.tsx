      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-800 p-8 rounded-xl shadow-lg">
              ...
              <div className="mt-6">
                <button
                  ...
                  className={`w-full bg-blue-700 text-white py-2 px-4 rounded-md hover:bg-blue-800 transition-colors duration-300 flex items-center justify-center ${
              ...
              {submitSuccess && (
                <div className="mt-4 p-4 bg-green-900 text-green-300 rounded-md">Message sent successfully!</div>
              )}
            </form>
          </motion.div>
        </div>
